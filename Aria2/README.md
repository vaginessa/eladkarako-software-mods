<h1><img src="resource/icon.png"/>Aria2</h1>
...
Libraries: zlib/1.2.11 expat/2.2.0 sqlite3/3.21.0 OpenSSL/1.0.2m c-ares/1.13.0 libssh2/1.7.0
Compiler: mingw-w64 5.0 (alpha) / gcc 6.3.0 20170516
  built by  x86_64-pc-linux-gnu
  targeting i686-w64-mingw32
  on        Nov 10 2017 11:06:17
System: Windows 7 (Service Pack 1) (6.1)

Report bugs to https://github.com/aria2/aria2/issues
Visit https://aria2.github.io/
</pre>

plus manifest, icon and versioninfo data.

<br/>
<hr/>

here are all the available switches (using <code>-h#all</code> ...)<br/>
<pre>
...
Options:
 ...
 --conf-path=PATH             Change the configuration file path to PATH.
                              ...
                              Possible Values: /path/to/file
                              Default: C:/Users/Elad/.config/aria2/aria2.conf
                              Tags: #advanced
 ...
 --dht-file-path=PATH         Change the IPv4 DHT routing table file to PATH.
                              ...
                              Possible Values: /path/to/file
                              Default: C:/Users/Elad/.cache/aria2/dht.dat
                              Tags: #bittorrent
 ...
 --dht-file-path6=PATH        Change the IPv6 DHT routing table file to PATH.
                              ...
                              Possible Values: /path/to/file
                              Default: C:/Users/Elad/.cache/aria2/dht6.dat
                              Tags: #bittorrent
